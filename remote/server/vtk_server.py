...
class _WebCone(vtk_wslink.ServerProtocol):
    ...
    def initialize(self):
        ...
        if not _WebCone.view:
            ...
            fitsReader.SetFileName("vlkb-merged_3D_2021-02-18_12-36-07_979531_16774-16806.fits");
            fitsReader.Update();
            ...
            popSplatter.SetSampleDimensions(500, 500, 500)
            popSplatter.SetRadius(0.001)
