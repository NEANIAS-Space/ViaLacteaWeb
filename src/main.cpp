...
int test_structured(const char* filename)
{
    ...
    vtkSmartPointer<vtkInteractorStyleTrackballCamera> style = vtkSmartPointer<vtkInteractorStyleTrackballCamera>::New(); // like
        // paraview
...
int main(int argc, char* argv[])
{
    ...
    std::array<std::pair<std::string, float>, 4> names = { { std::pair<std::string, float>("vlkb-cutout_2021-02-18_12-33-05_516569_JCMT-HARP_COHRS_18p00_0p00_CUBE_REBIN_R1.fits", 55),
